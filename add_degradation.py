### Derived from https://github.com/Kaiwen-Zhu/AgenticIR/blob/main/dataset/add_single_degradation.py

# --- compat shim for old BasicSR expecting torchvision.transforms.functional_tensor ---
import sys, types
from torchvision.transforms import functional as F

m = types.ModuleType("torchvision.transforms.functional_tensor")
# 只映射你这次会用到的函数；当前报错只需要 rgb_to_grayscale
